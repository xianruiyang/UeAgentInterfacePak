---
title: "纹理材质函数"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/texturing-material-functions-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "设计视觉、渲染和图形效果", "材质", "材质函数", "材质函数参考", "纹理材质函数"]
---

# 纹理材质函数

> 路径：虚幻引擎5.7文档 / 设计视觉、渲染和图形效果 / 材质 / 材质函数 / 材质函数参考 / 纹理材质函数

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/texturing-material-functions-in-unreal-engine
...
![CylindricalUVs（圆柱形 UV）](../../../../../../assets/images/d6/d632add13b526ea3b94b93c242752c595b67586f82d082e4f477b37568994ce4.jpg)
...
![DetailTexturing（细节纹理处理）](../../../../../../assets/images/85/8503506d6bcca599ea6c28412df424fc232a2e0344367fe823bfa044490d381b.jpg)
...
![LocalAlignedTexture（局部一致纹理）](../../../../../../assets/images/7d/7d380e3b506a1c7269bf0330fd0a73ba871fc02eb638878b5b07eef89d129034.jpg)
...
![TextureCropping（纹理裁切）](../../../../../../assets/images/db/dbc4f57e73761b9ba1a85abe0e963b674c61cf8e5519591ca3e677aa4b91435d.jpg)
...
![WorldAlignedNormal（全局一致法线）](../../../../../../assets/images/2f/2feef2b24cfab91b3bfa2c2497bf20563d99e35e1600b8f5767a41b78e28326c.jpg)
...
![WorldAlignedTexture（全局一致纹理）](../../../../../../assets/images/78/7870fba5625b2c779f9114adda396af12e4057341dadf50bac8699cbe7a066aa.jpg)
...
![3DSandMayaUVCoordinates（3D 沙 Maya UV 坐标）](../../../../../../assets/images/bf/bf16af6e9cc679d2694b5028126d393c579c7d7622a1fff012d9f4e850dbf358.jpg)
...
![CustomRotator（定制旋转）](../../../../../../assets/images/34/34d3bfbdd6b422d8c3f4c3f558d957612a80536d8c7e431321d3fc1b30501269.jpg)
...
| **使用反射矢量（静态布尔值）（Use Reflection Vector (StaticBool)）** | 如果为 *true*，那么将使用 ReflectionVector（反射矢量）而非 CameraVector（摄像机矢量）（材质的"法线"（Normal）输入将影响结果）。默认值为 *false*。但是，目前没有此开关的 false 输入数据，因此将其保持设置为 *false* 不会产生任何结果。 |
| **使用可平滑法线（静态布尔值）（Use Smoothable Normals (StaticBool)）** | 如果为 *true*，那么将使用 ReflectionVector（反射矢量）而非 CameraVector（摄像机矢量）（材质的"法线"（Normal）输入将影响结果）。默认值为 *false*。但是，目前没有此开关的 false 输入数据，因此将其保持设置为 *false* 不会产生任何结果。 |
...
> 图片已省略：CameraWorldBlend（摄像机全局混合）
...
| **单个纹理（静态布尔值）（Single Texture (StaticBool)）** | 设置为 *true* 时，将仅使用应用于 *XY 纹理（XY Texture）*输入的纹理，并将其投射到全部三个面。 |
...
> 图片已省略：WorldCoordinate3Way（全局坐标三向）
