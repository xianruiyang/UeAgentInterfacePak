---
title: "碰撞响应参考"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/collision-response-reference-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "物理", "碰撞", "碰撞响应参考"]
---

# 碰撞响应参考

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 物理 / 碰撞 / 碰撞响应参考

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/collision-response-reference-in-unreal-engine
...
默认碰撞配置文件以及已在 **项目设置（Project Settings）** -> **引擎（Engine）** -> **碰撞（Collision）** -> **预设值（Preset）** （请参阅[为项目添加自定义物体类型](../collision-tutorials/add-a-custom-object-type-to-your-project/index.md)了解详情）中创建的碰撞配置文件将在此处显示。
