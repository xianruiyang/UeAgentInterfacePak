---
title: "Iris简介"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/introduction-to-iris-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "联网和多人游戏", "Iris复制系统", "Iris简介"]
---

# Iris简介

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 联网和多人游戏 / Iris复制系统 / Iris简介

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/introduction-to-iris-in-unreal-engine
...
![Iris Design Diagram](../../../../../assets/images/13/139bbf70327193be21974db514194716276d18af6c946186a5c0d12011f9e060.png)
...
| **组件** | **说明** |
| --- | --- |
| 复制状态 | 包含需要复制的数据的结构体。复制系统将维护游戏的所有联网状态数据的副本。 |
| 优先级安排 | 排定复制Actor和对象的优先顺序。 |
| 筛选 | 筛选允许哪些Actor复制到哪些连接。 |
| 网络序列化器 | 序列化数据以通过网络连接进行传输。 |
| 数据流 | 通过网络连接实现数据复制的接口。 |
...
虚幻引擎默认使用Iris编译，但现有复制系统仍用作默认复制系统。要在你的项目中启用Iris，请确保启用了Iris插件，方法是将下面的代码块添加到你的 `.uproject` 文件的 `插件` 分段：
