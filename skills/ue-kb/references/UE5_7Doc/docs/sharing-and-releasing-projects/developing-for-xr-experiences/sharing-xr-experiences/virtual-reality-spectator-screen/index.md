---
title: "虚拟现实旁观者模式"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/virtual-reality-spectator-screen-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "分享和发布项目", "XR开发", "共享XR体验", "虚拟现实旁观者模式"]
---

# 虚拟现实旁观者模式

> 路径：虚幻引擎5.7文档 / 分享和发布项目 / XR开发 / 共享XR体验 / 虚拟现实旁观者模式

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/virtual-reality-spectator-screen-in-unreal-engine
...
| 节点 | 描述 |
| --- | --- |
| **[设置旁观者屏幕纹理](set-spectator-screen-texture/index.md)** | 此节点可以更改社交（旁观者）屏幕上显示的纹理。 |
| **[设置旁观者屏幕模式 TexturePlusEye布局](set-spectator-screen-mode-tex-272a7268/index.md)** | 此节点设置了ESpectatorScreenMode中的TexturePlusEye函数的布局。 |
| **[设置旁观者屏幕模式](set-spectator-screen-mode/index.md)** | 此节点设置了社交（旁观者）屏幕模式。 |
