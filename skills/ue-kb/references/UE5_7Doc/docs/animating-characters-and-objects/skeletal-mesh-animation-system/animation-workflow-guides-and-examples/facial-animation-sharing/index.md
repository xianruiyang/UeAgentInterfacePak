---
title: "面部动画共享"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/facial-animation-sharing-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "为角色和对象制作动画", "骨架网格体动画系统", "动画操作指南和示例", "面部动画共享"]
---

# 面部动画共享

> 路径：虚幻引擎5.7文档 / 为角色和对象制作动画 / 骨架网格体动画系统 / 动画操作指南和示例 / 面部动画共享

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/facial-animation-sharing-in-unreal-engine

![FacialAnimationSharing.png](../../../../../assets/images/d8/d843d1e7c826d14531be3a9dcdf997db3e0bc12bc08c70945b14244d0f1ee605.png)
...
![MasterSkeleton_01.png](../../../../../assets/images/88/8806dd4c06e7e37a19e6ebbe8ea501982fcccc7e1ec6de38c6a3532df5188a6b.png)

> [!NOTE]
> 请参阅[骨骼资源](../../animation-assets-and-features/skeletons/index.md)文档页面以了解关于骨骼的更多信息。

## 创建姿势资源

接下来需要在DCC内部，烘焙姿势到FBX序列，并将该FBX导入到虚幻引擎中。这样将产生一个动画序列，其中包含处于最小/最大混合值的每一个曲线。

![undefined](../../../../../assets/images/3c/3cba49a91ec6806bdb463370d47417c350a4fb177e9c21652c1a0da19b97d66d.jpg)

单击查看大图。

在上图中，导入的动画序列包含所有曲线以及给定帧处的最大值。

导入了包含所有曲线数据的序列后，可以从该动画序列创建[姿势资源](../../animation-assets-and-features/animation-pose-assets/index.md)，继而用来将动画曲线数据转换为角色的实际面部动画。

![AnimationSequence_02.png](../../../../../assets/images/88/886b6f968b22e4b0b9160ab4836c0aa2ace317ada58891788c9bef5c09905715.jpg)
...
![Facial_Poses.png](../../../../../assets/images/46/464d912040d46916c593aa0bd206c65fbb29b0f3adf448317ffeeef795b8e9c4.png)

然后，我们可以将它们作为姿势资源中的姿势名称应用：

然后您将会在随着骨架资源一起存储的 **动画曲线（Anim Curves）** 窗口中看到这些曲线。

![undefined](../../../../../assets/images/29/29a7b3c1658e0e89f23040ecf9601eba0419e654b2a98dcab2887ac662c771ec.jpg)

单击查看大图。

每一个使用主骨架的角色都会访问这些曲线，并用每个曲线中表示的不同值驱动自己的面部表情，同时姿势资源将所有曲线数据转换为角色采用的实际动画姿势。

![AnimationSequence_03.png](../../../../../assets/images/5f/5fff7a49a5605ad1ec8e8dc16cadc5a31e6730925defe41ee88e98060030dfe8.jpg)
...
![PoseRename1-1.png](../../../../../assets/images/00/0073253e00c3f3f7954b9dd4f98ad64c3dfd24e176787d811dcb02fcb9b1c0e5.jpg)
...
> 图片已省略：BringInAnimation_04.png

您还可以使用动画修饰符移除特定骨骼，但前提是您只想共享肢体动画，而不是面部的驱动曲线。通常，您需要有骨骼驱动的肢体动画，而不是曲线驱动的面部表情，此时我们可以选择使用动画修饰符。

> 图片已省略：BringInAnimation_02.png

这里，动画序列和指定的要移除的骨骼轨道（包括其子代）在应用修饰符后就完成了。

> [!TIP]
> 您可以将[父类](../../../../blueprints-visual-scripting/specialized-blueprint-visual-scripting-node-groups/types-of-blueprints/blueprint-class-assets/creating-blueprint-classes/index.md)设置为动画修饰符来创建蓝图，从而创建动画修饰符。

在您导入的任何动画上，可以前往动画修饰符部分，应用您创建的动画修饰符来移除骨骼变形。

> 图片已省略：BringInAnimation_03.png
