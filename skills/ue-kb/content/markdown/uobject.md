...
---
title: "UObject实例创建"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/creating-objects-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "用C++编程", "虚幻引擎反射系统", "对象", "UObject实例创建"]
---

# UObject实例创建

> 路径：虚幻引擎5.7文档 / 用C++编程 / 虚幻引擎反射系统 / 对象 / UObject实例创建

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/creating-objects-in-unreal-engine
...
通过允许为新实例指定一个名称以及[对象标记](#%E5%AF%B9%E8%B1%A1%E6%A0%87%E8%AE%B0)和一个要指定为参数的模板对象， `NewNamedObject()` 在 `NewObject()` 上展开。
