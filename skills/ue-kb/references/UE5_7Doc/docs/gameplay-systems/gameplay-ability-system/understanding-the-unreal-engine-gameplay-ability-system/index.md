---
title: "Gameplay技能系统概述"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/understanding-the-unreal-engine-gameplay-ability-system"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "Gameplay技能系统", "Gameplay技能系统概述"]
---

# Gameplay技能系统概述

> 路径：虚幻引擎5.7文档 / Gameplay系统 / Gameplay技能系统 / Gameplay技能系统概述

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/understanding-the-unreal-engine-gameplay-ability-system
...
> [!NOTE]
> [Lyra示例项目](../../../samples-and-tutorials/sample-game-projects/lyra-sample-game/index.md)还会追踪何时授予技能。
...
- Gameplay技能蓝图（Gameplay Ability Blueprints）

  ，表示各个技能，并协调其游戏内执行。

  - 由

    Gameplay技能任务（Gameplay Ability Tasks）
...
- 属性集（Attribute Set）
  ...
  - 包含
    ...
    Gameplay属性（Gameplay Attributes）
...
- Gameplay效果（Gameplay Effects）
  ...
  - Gameplay效果计算（Gameplay Effect Calculations）

    ，提供模块化、可复用的方法来计算效果。
  - Gameplay提示（Gameplay Cues）

    ，与Gameplay效果关联，并提供数据驱动的方法来处理视觉效果。
...
- 使用
  ...
  。这些会添加到技能系统组件，在调用时会触发匹配的所有技能。其运作方式类似于Gameplay事件。
...
有关Gameplay技能系统的实操运行模型，请检查[Lyra示例游戏项目](../../../samples-and-tutorials/sample-game-projects/lyra-sample-game/abilities-in-lyra/index.md)，它实现了多项技能和武器。要开始亲自处理这些构建块，请学习《Gameplay技能系统快速入门指南》。
