---
title: "图形编程介绍"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/graphics-programming-overview-for-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "设计视觉、渲染和图形效果", "图形编程", "图形编程介绍"]
---

# 图形编程介绍

> 路径：虚幻引擎5.7文档 / 设计视觉、渲染和图形效果 / 图形编程 / 图形编程介绍

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/graphics-programming-overview-for-unreal-engine
...
- 请参阅 [着色器开发](../shader-development/index.md) 了解更多关于着色器使用的信息。
- 请参阅 [坐标空间](https://dev.epicgames.com/documentation/unreal-engine/coordinate-system-and-spaces-in-unreal-engine) 查看 Unreal Engine 中使用的坐标空间术语的解释。
...
Unreal Engine 中拥有和游戏线程并行运行的 [渲染线程](../threaded-rendering/index.md)。大多数将游戏线程与渲染线程连接在一起的类都会根据对相应状态拥有所有权的线程分为两个部分。
...
以及相同类（按哪个线程对其状态拥有所有权进行排列）。请务必随时了解您正在为其编写代码的状态的所有权属于哪个线程，[避免出现竞态条件](../threaded-rendering/index.md)
