---
title: "Sprite 碰撞"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/paper-2d-sprite-collision-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "为角色和对象制作动画", "虚幻引擎", "Paper 2D Sprites", "Sprite 碰撞"]
---

# Sprite 碰撞

> 路径：虚幻引擎5.7文档 / 为角色和对象制作动画 / 虚幻引擎 / Paper 2D Sprites / Sprite 碰撞

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/paper-2d-sprite-collision-in-unreal-engine
...
| 类型 | 描述 |
| --- | --- |
| **源边界框式** | 在 Sprite 上使用 [源区](../index.md) 的边界框。 |
| **严格边界框式** | 生成严格边界框，将 sprite 的全透明区域排除在外。多数情况下这种方式能生成更佳的碰撞效果。 |
| **收缩包裹式** | （*实验性*）生成匹配 Sprite 不透明区域的复杂几何体。这种方式能产生最真实的碰撞效果，但额外的几何体可能对运行性能产生影响。 |
| **自定义式** | 可指定视口中互动使用的几何体。 |
