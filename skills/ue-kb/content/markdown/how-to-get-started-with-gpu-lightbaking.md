# How To Get Started With GPU Lightbaking

# How To Get Started With GPU Lightbaking

## 知识目标

- 围绕“How To Get Started With GPU Lightbaking”整理 PCG 视频中的输入数据、图表规则、关键节点、参数风险和最终生成结果。
...
- `PCG`、`Blueprint`、`Static Mesh`、`Mesh`、`Spline`、`Transform`、`Point`、`Component`、`Spawn`、`Grid`、`Random`、`Graph`、`Mask`、`Instance`、`static`、`bake`、`sure`、`default`、`PCG Graph`、`Volume`、`Static Mesh Spawner`、`Transform Points`、`Partition`、`GPU`

## 分段知识

### 00:00:00-00:04:50 Spline 采样与路径生成
...
- 核对对象：`PCG Graph`、`PCG`、`Point`、`Spline`、`Volume`、`Blueprint`、`Static Mesh`、`Static Mesh Spawner`、`Transform Points`、`Random`。
...
- 核对对象：`PCG`、`Point`、`Volume`、`Partition`、`Random`、`GPU`、`属性`、`过滤`。
