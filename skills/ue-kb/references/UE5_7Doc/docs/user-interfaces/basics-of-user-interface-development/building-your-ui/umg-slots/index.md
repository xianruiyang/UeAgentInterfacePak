---
title: "UMG插槽"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/umg-slots-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "创建用户界面", "构建用户界面", "构建你的UI", "UMG插槽"]
---

# UMG插槽

> 路径：虚幻引擎5.7文档 / 创建用户界面 / 构建用户界面 / 构建你的UI / UMG插槽

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/umg-slots-in-unreal-engine
