---
title: "资产和包的版本控制"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/versioning-of-assets-and-packages-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "用C++编程", "虚幻架构", "资产和包的版本控制"]
---

# 资产和包的版本控制

> 路径：虚幻引擎5.7文档 / 用C++编程 / 虚幻架构 / 资产和包的版本控制

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/versioning-of-assets-and-packages-in-unreal-engine
...
![The About Unreal Editor dialogue box displays the current version of the Unreal Editor as well as the current changelist.](../../../../assets/images/6e/6e40cc20f73f649babed838f8a2ce4cd77adcb99e6125320ab64104ae16d8966.jpg)
...
构建的引擎版本由引擎中的 `/Build/Build.version` 中定义的值来控制。该文件可以通过手动编辑进行更新，可以运行 `UpdateLocalVersion` 命令或通过[虚幻游戏同步](../../../production-pipeline/deploying/unrealgamesync-ugs/index.md)进行同步。以下字段是从 `/Build/Build.version` 文件读取的：
...
| `Changelist` | 手动定义。可以手动更新，或者使用 `UpdateLocalVersion` **自动化工具（AutomationTool）** 工具由构建系统更新。这将使用构建的depot路径名，用加号取代斜杠。 |
...
```
	const FGuid FAnimationCustomVersion::GUID(0x2EB5FDBD, 0x01AC4D10, 0x8136F38F, 0x3393A5DA);	// 将自定义版本注册到核心	FCustomVersionRegistration GRegisterAnimationCustomVersion(FAnimationCustomVersion::GUID, FAnimationCustomVersion::LatestVersion, TEXT("AnimGraphVer")); 
```
...
> [!NOTE]
> **注意：** 请参阅[二进制文件的版本管理](../../../production-pipeline/using-the-unreal-engine-build-pipeline/unreal-build-tool/how-to-version-binaries/index.md)参考页面以了解详情。
