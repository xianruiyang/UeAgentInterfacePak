---
title: "二进制文件版本划分"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/how-to-version-binaries-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "建立你的开发流程", "用虚幻构建管线", "虚幻编译工具", "二进制文件版本划分"]
---

# 二进制文件版本划分

> 路径：虚幻引擎5.7文档 / 建立你的开发流程 / 用虚幻构建管线 / 虚幻编译工具 / 二进制文件版本划分

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/how-to-version-binaries-in-unreal-engine
