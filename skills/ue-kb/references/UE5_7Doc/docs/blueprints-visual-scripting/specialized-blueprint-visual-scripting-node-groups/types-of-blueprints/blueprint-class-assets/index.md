---
title: "蓝图类"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/blueprint-class-assets-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "蓝图可视化脚本", "专用蓝图节点组", "蓝图类型", "蓝图类"]
---

# 蓝图类

> 路径：虚幻引擎5.7文档 / 蓝图可视化脚本 / 专用蓝图节点组 / 蓝图类型 / 蓝图类

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/blueprint-class-assets-in-unreal-engine
...
> [!NOTE]
> 根据所用的方法 [创建一个蓝图类](creating-blueprint-classes/index.md), 一个父类将在被创建时分配。
...
- [蓝图编辑器中的蓝图类UI](../../../user-interface-reference-for-the-blue-73593f79/user-interface-breakdown/blueprints-visual-scripting-user-interface-for-871cf78a/index.md)

- [创建蓝图类](creating-blueprint-classes/index.md) - 新建蓝图类的指南。

- [蓝图编辑器参考](../../../user-interface-reference-for-the-blueprints-vis-53faed96/index.md) - 本页包含蓝图编辑器的界面元素和基础使用说明。
