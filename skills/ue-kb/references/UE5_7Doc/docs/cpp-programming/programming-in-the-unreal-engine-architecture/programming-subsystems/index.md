---
title: "编程子系统"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/programming-subsystems-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "用C++编程", "虚幻架构", "编程子系统"]
---

# 编程子系统

> 路径：虚幻引擎5.7文档 / 用C++编程 / 虚幻架构 / 编程子系统

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/programming-subsystems-in-unreal-engine
...
- 不存在
  ...
  的游戏特定导数。
- UMyGamesGameInstance

  存在，但是它已拥有大量函数，添加更多函数并不理想。
