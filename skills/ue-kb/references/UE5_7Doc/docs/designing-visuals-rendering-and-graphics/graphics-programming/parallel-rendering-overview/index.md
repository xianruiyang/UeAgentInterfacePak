---
title: "并行渲染介绍"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/parallel-rendering-overview-for-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "设计视觉、渲染和图形效果", "图形编程", "并行渲染介绍"]
---

# 并行渲染介绍

> 路径：虚幻引擎5.7文档 / 设计视觉、渲染和图形效果 / 图形编程 / 并行渲染介绍

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/parallel-rendering-overview-for-unreal-engine
