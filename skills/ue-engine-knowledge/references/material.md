...
材质图、Material Instance、Material Function、参数、透明、WPO、优化和 Niagara/UMG 表现协作。
...
- Master Material 定结构，Material Instance 调参数。
- 重复节点收敛为 Material Function。
- 透明排序、深度和 overdraw 要尽早验证。
- 运行时只改参数或 Material Parameter Collection。
