---
title: "模块API的说明符"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/module-api-specifiers-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "用C++编程", "虚幻架构", "虚幻引擎模块", "模块API的说明符"]
---

# 模块API的说明符

> 路径：虚幻引擎5.7文档 / 用C++编程 / 虚幻架构 / 虚幻引擎模块 / 模块API的说明符

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/module-api-specifiers-in-unreal-engine
