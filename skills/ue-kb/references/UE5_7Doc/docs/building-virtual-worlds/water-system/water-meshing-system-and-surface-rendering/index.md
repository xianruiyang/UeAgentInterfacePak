---
title: "水体的网格系统及表面渲染"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/water-meshing-system-and-surface-rendering-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "构建虚拟世界", "水体系统", "水体的网格系统及表面渲染"]
---

# 水体的网格系统及表面渲染

> 路径：虚幻引擎5.7文档 / 构建虚拟世界 / 水体系统 / 水体的网格系统及表面渲染

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/water-meshing-system-and-surface-rendering-in-unreal-engine
...
![Create Landscape](../../../../assets/images/64/640496aa8cfbf940bbee54037bfd5d6ab03caf6d8868bc19e499824a841c434a.jpg)
...
![undefined](../../../../assets/images/75/75feb7dc8a7e2e7d104f5f53caef7de8fe55aebe68ccf80eab86cc3dd8b7b9c4.jpg)
...
| --- | --- |
| 4x4四叉树网格变为2x2网格又变回来的示例。 | 《堡垒之夜》中的水LOD过渡示例。 |
...
>
>   视图模式。如果你在场景中没有大量几何结构，或者只有可见的水网格体，这种方法非常适合。
> - 使用控制台命令将水网格体渲染为线框：
>
...
![Water Mesh Tile Settings](../../../../assets/images/ff/ffa2ddaca26274b000ee566528efcc8ec036d508dccc2e66f5153e01c8288c2c.png)
...
| --- | --- | --- |
| 图块大小网格示例 | 水网格体图块大小：2400（默认大小） | 水网格体图块大小：1000 |
...
![水网格体Actor远距离：已禁用](../../../../assets/images/8d/8df8a3b1cc122050bbbac2e503de55b7eaf3ea44921878b06b1e12603e948576.jpg)

![水网格体Actor远距离：已启用](../../../../assets/images/fd/fd59e7288c42d27c1c0c86b61735b499f9f1f990190e12dd1c02a81548ae6aba.jpg)
...
![水网格体Actor远距离：已禁用](../../../../assets/images/7f/7fbf49a5f83537f88fcab4d8a381c6fe3922c5aac518ea457b3148896e66bd83.png)

![水网格体Actor远距离：已启用](../../../../assets/images/e8/e8d97eae32478144d194d6a77efb4793781008b07ba3c0a6afac7d33447d18fc.png)
...
> [!TIP]
> 基底水材质有一种称为 **Water_FarMesh** 的简化材质实例，在内容浏览器的 `Water Content/Materials/WaterSurface` 文件夹中可供使用。
...
![Underwater post process settings](../../../../assets/images/ed/edf241a3d8bd0eacb9d83c942445ebf4106512f82ea89024e46691b20492f5b8.png)
...
| [Water basematerial](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/9e6f3f4f-d152-421d-b396-dcdbc93ce4fe/19-water-basematerial.png) 点击查看大图。 | [Water material instance](https://d1iv7db44yhgxn.cloudfront.net/documentation/images/6270ca9e-da0e-445d-b2f6-93ee466a38cd/20-water-material-instance.png) 点击查看大图。 |
| --- | --- |
| 带有开关和参数的基底材质 | 使用重载开关和参数的材质实例 |
...
每个水体都指定了 **水下后期处理材质（Underwater Post Process Material）**，以使用[后期处理材质](../../../designing-visuals-rendering-and-graphics/post-process-effects/post-process-materials/index.md)驱动穿过水面的过渡。摄像机位于给定水体边界之内，沉没到水面以下时，会自动进行水下后期处理。后期处理材质还会屏蔽掉场景中不在水下的部分来创建部分水下的视图，从而处理进入和离开水面的过渡。

> 图片已省略：Water underwater post processing

点击查看大图。

每种水体的 **细节（Details）** 面板包含Actor的特定设置，并且可在其中访问 **后期处理设置（Post Processing Settings）**，进一步调整水下的外观，无需打开并手动配置材质属性。

> 图片已省略：Water underwater post processing material slot
...
> 图片已省略：Water single layer water material
...
>
> 要获取有关此着色模型的更多信息，请参阅[单层水着色模型](../../../designing-visuals-rendering-and-graphics/unreal-engine-materials/unreal-engine-material-properties/shading-models/single-layer-water-shading-model/index.md)。
...
- 材质需要启用
  ...
  。每当将材质指定给不同类型的Actor时，此标记应该会自动启用，并且该材质将重新编译。如果不是这种情况，材质未正确渲染，请检查此标记是否已启用。
- SingleLayerWater

  着色模型可提供半透明和照明结果，成本以比传统半透明材质更低。
