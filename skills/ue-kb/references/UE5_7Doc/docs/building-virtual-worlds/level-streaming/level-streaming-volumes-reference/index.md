---
title: "关卡流送体积参考"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/level-streaming-volumes-reference-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "构建虚拟世界", "关卡流送", "关卡流送体积参考"]
---

# 关卡流送体积参考

> 路径：虚幻引擎5.7文档 / 构建虚拟世界 / 关卡流送 / 关卡流送体积参考

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/level-streaming-volumes-reference-in-unreal-engine

**关卡流送体积** 用于辅助[关卡流送](../index.md)流程。它们允许你简单封装关卡，并控制其何时在内存中加载或卸载（在玩家进入或离开体积时）。
...
卸载滞后量可以通过修改[关卡窗口](../../../understanding-the-basics/levels/managing-multiple-levels/index.md)中的流送关卡的 **体积卸载请求之间的最小时间（Min Time Between Volume Unload Requests）** 来调整。 默认卸载滞后为2.0秒。
