---
title: "如何使用混合现实捕捉校准工具"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/how-to-use-the-mixed-reality-capture-calibration-tool-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "使用媒体", "媒体集成", "混合现实捕获", "如何使用混合现实捕捉校准工具"]
---

# 如何使用混合现实捕捉校准工具

> 路径：虚幻引擎5.7文档 / 使用媒体 / 媒体集成 / 混合现实捕获 / 如何使用混合现实捕捉校准工具

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/how-to-use-the-mixed-reality-capture-calibration-tool-in-unreal-engine

校准的目标是在虚拟场景中将虚拟摄像机和物理摄像机相匹配。

AdjustingAlignmentStep.png 在运行时，游戏需要知道一些信息，例如：
...
![MR_GreenScreenSetup.png](../../../../../assets/images/8e/8ec9dbd0115254cc8863440c4cc81cc50873284657e7ced1db8f1fe67e016781.jpg)

1. 摄像机

   UE4 仅支持一组非常特定的视频捕捉设备。有关支持的设备列表，请参见
...
4. 多重安装 + 跟踪器（选件）
   ...
   如果你打算在拍摄期间四处移动摄像机，最好将跟踪设备（例如HTC Vive Tracker）连接到摄像机。另外，你还可以使用
...
![MR_RequiredSetupItems.jpg](../../../../../assets/images/4b/4bae2785f51725247194ee6578bbfd37fc352d7c85cb8ce5ec8dcad2174e57ed.jpg)
...
![MR_DeviceSelection.png](../../../../../assets/images/a0/a08deee9480300dd7369c89f5b6bb14d68e043a062dbec98da5565fa82899af6.jpg)
...
![MR_ReprojectionError.png](../../../../../assets/images/a5/a5d5b6d6c08641efeec717a64d060eabe7659803b44b35251d67930f0e17d66c.jpg)
...
![MR_FOVFormula.png](../../../../../assets/images/fb/fbeb5e535012e12d1d88f38854ef725d4d2ea18386e409db820c8015f3b9379d.png)
...
![AdjustingAlignment2.png](../../../../../assets/images/69/69fb6e241f0ea9ade6184f7fcd7e34cb49e66028a0cdd9205f3bf9f9d34664cd.png)
...
![MR_PreviewResults.png](../../../../../assets/images/ab/ab290a389191b9ff3a97a51d6f7e43204290fe726455f4cbc46bab0596e83f5d.jpg)
...
![MR_MakingAdjustments.png](../../../../../assets/images/27/2776b92e4d71dc13833f230e9b94cf197da62cb3853e1e6cc59c93c09aaa8194.jpg)
...
> 图片已省略：MR_CompositingCalibratrion.png
...
| 左控制器 | 右控制器 |
| --- | --- |
| **握柄（Grip）**：Alt （握住它时功能按钮会改变） **扳机（Trigger）（握住并拖动）**：移动Gizmo **摇杆（Thumbstick）**：撤消 握住左握柄（w/ LGrip held） **扳机（Trigger）**：Gizmo位置复位 **摇杆（Thumbstick）**：再次运行 | **握柄（Grip）**：创建蒙版模型 **扳机（Trigger）**：选择/取消选择蒙版模型 **摇杆（Thumbstick）**：下一个Gizmo模式（旋转、平移、缩放等） 握住左握柄（w/ LGrip held） **扳机（Trigger）**：取消全选 **摇杆（Thumbstick）**：上一个Gizmo模式 |

与[VR场景编辑器](../../../../building-virtual-worlds/virtual-scouting/index.md)的工作原理类似，你可以放置和定位3D平面。将平面与要从捕捉中抠去的实际部分匹配。
