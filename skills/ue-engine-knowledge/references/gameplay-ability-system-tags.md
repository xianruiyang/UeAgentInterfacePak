# Gameplay Ability System / Gameplay Tags 知识卡

## 适用范围

GAS、Ability、Gameplay Effect、Attribute、Gameplay Cue、Tag Gate、Cooldown、Cost 和复制。
...
- Ability 表达能做什么，Gameplay Effect 表达状态和数值变化。
- AttributeSet 保存可复制数值，Tag 保存状态语义和门禁。
- Gameplay Cue 用于表现触发，不承载权威判定。
- 多人项目必须明确 ASC 所在对象和 owner/avatar 关系。
