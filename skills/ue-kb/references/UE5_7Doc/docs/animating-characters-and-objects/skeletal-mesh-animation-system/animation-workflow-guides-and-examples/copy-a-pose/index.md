---
title: "从另一个骨架网格体复制姿势"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/copy-a-pose-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "为角色和对象制作动画", "骨架网格体动画系统", "动画操作指南和示例", "从另一个骨架网格体复制姿势"]
---

# 从另一个骨架网格体复制姿势

> 路径：虚幻引擎5.7文档 / 为角色和对象制作动画 / 骨架网格体动画系统 / 动画操作指南和示例 / 从另一个骨架网格体复制姿势

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/copy-a-pose-in-unreal-engine
...
4. 在 **组件（Components）** 窗口中选中 **网格体（Mesh）**，然后在 **细节（Details）** 面板中，将 **动画类（Anim Class）** 设置为 **UE4_Mannequin_Skeleton_AnimBlueprint**。
