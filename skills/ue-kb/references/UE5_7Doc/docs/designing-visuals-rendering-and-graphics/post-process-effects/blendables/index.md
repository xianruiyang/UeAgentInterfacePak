---
title: "可混合物"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/blendables-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "设计视觉、渲染和图形效果", "后期处理效果", "可混合物"]
---

# 可混合物

> 路径：虚幻引擎5.7文档 / 设计视觉、渲染和图形效果 / 后期处理效果 / 可混合物

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/blendables-in-unreal-engine
