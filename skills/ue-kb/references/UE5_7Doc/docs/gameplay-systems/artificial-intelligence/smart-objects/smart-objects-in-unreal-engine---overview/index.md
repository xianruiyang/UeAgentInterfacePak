---
title: "智能对象概述"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/smart-objects-in-unreal-engine---overview"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "人工智能", "智能对象", "智能对象概述"]
---

# 智能对象概述

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 人工智能 / 智能对象 / 智能对象概述

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/smart-objects-in-unreal-engine---overview
...
- 批量实体行为（Mass Entity Behavior）

  - 包含的数据用于配置可由批量实体使用的智能对象。
- Gameplay行为（Gameplay Behavior）

  - 包含的数据用于配置可由Gameplay行为插件使用的智能对象。
...
3. 智能对象子系统会将智能对象结果返回给代理。智能对象结果是结构体数组，包含所有匹配的智能对象ID及其空闲插槽。
   ...
   ![undefined](../../../../../assets/images/e6/e6f964934e4ad28eaa14097b6520b83d0376b8692ce1fa05c87cf5391884ec36.png)

   ![带有两个空闲插槽的智能对象](../../../../../assets/images/cc/cca6eafd9ff11ee21587e0f24497569bec3d70b3b12ed603f2beb23545ff58fb.jpg)
...
5. 代理会检查认领句柄是否有效。如果有效且认领尝试成功，则可以继续下一步。但是，如果认领句柄无效，代理可能会尝试从智能对象结果中认领另一个智能对象。
   ...
   ![undefined](../../../../../assets/images/a7/a70e21fa3aa36ab9ed73ba49acb45dc8fbfdd14a583876ac03a0fe30d5db1b68.png)

   ![带有两个已认领插槽的智能对象](../../../../../assets/images/cc/cca6eafd9ff11ee21587e0f24497569bec3d70b3b12ed603f2beb23545ff58fb.jpg)
...
6. 智能对象子系统会将 **行为定义** 结构体返回给代理。行为定义将包含代理在插槽位置执行其所需行为的所有必要数据。
   ...
   ![undefined](../../../../../assets/images/74/7458763ab1ec037775d6a8bc6f212aaadc2403b3f813c8501e16a1b481eb3466.png)

   ![具有已占用插槽和已认领插槽的智能对象](../../../../../assets/images/57/57136b72d789c7e020af74144ebbf2d1760bb44652166cc44db3d587c53a3bb7.jpg)
...
4. 代理现在可以自由执行另一行为，或搜索另一个智能对象。
   ...
   ![undefined](../../../../../assets/images/da/da47b08889625b94a686dc55202b292768096d91c3d2a8a7d4573a04c19b801a.png)
