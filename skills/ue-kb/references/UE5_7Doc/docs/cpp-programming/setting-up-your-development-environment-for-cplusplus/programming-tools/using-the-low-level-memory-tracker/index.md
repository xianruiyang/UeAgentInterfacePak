---
title: "低级内存跟踪器"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/using-the-low-level-memory-tracker-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "用C++编程", "开发设置", "编程工具", "低级内存跟踪器"]
---

# 低级内存跟踪器

> 路径：虚幻引擎5.7文档 / 用C++编程 / 开发设置 / 编程工具 / 低级内存跟踪器

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/using-the-low-level-memory-tracker-in-unreal-engine
...
| `-llmtagsets=Assets` | 实验性功能。显示每个资产分配的内存总计。 |
