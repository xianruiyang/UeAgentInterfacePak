---
title: "碰撞概述"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/collision-in-unreal-engine---overview"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "物理", "碰撞", "碰撞概述"]
---

# 碰撞概述

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 物理 / 碰撞 / 碰撞概述

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/collision-in-unreal-engine---overview
...
- 阻挡
  ...
  会设置为阻挡的两个（或更多）Actor之间自然发生。但是，需要启用
...
- 默认的
  ...
  摄像机是一个Pawn。因此可以被设置为阻挡Pawn的任何对象阻挡。
- 在编辑器中模拟
  ...
  Pawn。它可以自由穿过任何对象，不会造成任何碰撞或重叠事件。
