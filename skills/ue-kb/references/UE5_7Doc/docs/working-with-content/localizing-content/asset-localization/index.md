---
title: "资产本地化"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/asset-localization-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "管理内容", "本地化", "资产本地化"]
---

# 资产本地化

> 路径：虚幻引擎5.7文档 / 管理内容 / 本地化 / 资产本地化

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/asset-localization-in-unreal-engine
...
- 您可以使用[复合字体](../../../user-interfaces/text-formatting-localization-and-fonts/fonts/font-asset-and-editor/index.md)来生成适用于所有文化的单个字体资产。
...
现在，您可以将一种独特的文化指定给该资产组，而不影响项目的其余部分。详情请参阅[管理活跃的文化](../managing-the-active-culture-at-runtime/index.md)页面。
