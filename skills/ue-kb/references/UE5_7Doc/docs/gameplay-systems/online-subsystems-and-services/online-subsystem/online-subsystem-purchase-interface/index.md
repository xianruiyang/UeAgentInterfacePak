---
title: "购买接口"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/online-subsystem-purchase-interface-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "在线子系统和服务", "在线子系统", "购买接口"]
---

# 购买接口

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 在线子系统和服务 / 在线子系统 / 购买接口

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/online-subsystem-purchase-interface-in-unreal-engine
...
如需获取或过滤使用者可购买的商品，请使用[商店接口](https://dev.epicgames.com/documentation/404)。
...
准备好进行购买并选择商品后（如[商店接口](https://dev.epicgames.com/documentation/404)中所定义），用 `FPurchaseCheckoutRequest` 调用 `Checkout` 函数。 这通常会呼出在线服务特定的用户界面，并最终调用类型为 `FOnPurchaseCheckoutComplete` 的委托。 委托将包含成功或失败信息，如购买成功，则提供购买收据（类 `FPurchaseReceipt`）。
