...
source_url: "https://dev.epicgames.com/documentation/unreal-engine/paper-2d-tile-sets-and-tile-maps-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "为角色和对象制作动画", "虚幻引擎", "Paper 2D 图块集/图块地图"]
---

# Paper 2D 图块集/图块地图

> 路径：虚幻引擎5.7文档 / 为角色和对象制作动画 / 虚幻引擎 / Paper 2D 图块集/图块地图

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/paper-2d-tile-sets-and-tile-maps-in-unreal-engine
...
1. 点击 **内容浏览器** 中的 按钮，然后在 *Miscellaneous* 下选择 **Tile Set**。
2. 为新建的图块集资源命名。
...
![undefined](../../../../assets/images/1c/1c064fa2b6c89551a6718c85cb2032379c96f585cf6b36de271d36e1b5ba70aa.jpg)
...
3. 在 **Details** 面板中的 **Sprite** 部分下找到选中的图块并改为所需的 **几何体类型（Geometry Type）**。
   ...
   > [!NOTE]
   > 如需了解关于 sprite 碰撞类型的内容，请查阅 [**Sprite 碰撞**](../paper-2d-sprites/paper-2d-sprite-collision/index.md) 文档。
...
1. 在 **内容浏览器** 中点击 按钮，然后在 *Miscellaneous* 下选择 **Tile Map**。
2. 为新建的图块地图资源命名。
