---
title: "UMG样式"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/umg-styling-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "创建用户界面", "UMG编辑器参考", "UMG样式"]
---

# UMG样式

> 路径：虚幻引擎5.7文档 / 创建用户界面 / UMG编辑器参考 / UMG样式

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/umg-styling-in-unreal-engine
...
- 方框
  ...
  会绘制一个 3x3 的框，其中根据边距（蓝色虚线）来确定侧面和中间区域的拉伸（橙色箭头所指）。

  - 绿色箭头代表根据边距乘图像大小所得出的常数值。
- 边框

  会绘制一个 3x3 的边框，其中根据边距（蓝色虚线）来确定侧面的图块（橙色箭头所指）。

  - 使用边框选项时不会绘制中间部分。
  - 绿色箭头代表根据边距乘图像大小所得出的常数值。
- 图像

  将绘制图像并进行拉伸（橙色箭头所指），并且会忽略边距。
...
![undefined](../../../../assets/images/04/04b43b4a42e7c4f0cad885c06ad90fe2764e23489398b4c249114f1fdb958126.jpg)
...
![undefined](../../../../assets/images/be/be7c834248909f5a714c750b24776d863e63e62e3b88c9317d184bab15619c58.jpg)
