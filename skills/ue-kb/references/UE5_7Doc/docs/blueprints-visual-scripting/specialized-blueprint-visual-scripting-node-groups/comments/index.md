---
title: "注释"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/comments-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "蓝图可视化脚本", "专用蓝图节点组", "注释"]
---

# 注释

> 路径：虚幻引擎5.7文档 / 蓝图可视化脚本 / 专用蓝图节点组 / 注释

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/comments-in-unreal-engine
...
| --- | --- |
| **属性** |  |
| **注释颜色** | 该属性可以让你变更注释框的背景颜色。 请记住使用Alpha值来调整背景的透明度。 |
| **对注释泡泡上色** | 如此项被勾选，则 **注释颜色** 将会被应用到注释框中。 |
| **移动模式** | 该属性可让你设置在移动注释时是否要同时移动其中的节点，(如同时移动则为 **组移动** 模式) ，或移动注释时为单独移动，不移动其中的节点(**注释** 模式） |
