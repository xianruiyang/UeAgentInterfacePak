---
title: "使用Perforce版本控制软件"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/using-perforce-as-source-control-for-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "建立你的开发流程", "虚幻引擎中的协作和版本控制", "使用Perforce版本控制软件"]
---

# 使用Perforce版本控制软件

> 路径：虚幻引擎5.7文档 / 建立你的开发流程 / 虚幻引擎中的协作和版本控制 / 使用Perforce版本控制软件

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/using-perforce-as-source-control-for-unreal-engine
...
> [!TIP]
> 为了避免潜在的，与我们工具的集成问题，如[UnrealGameSync](../../deploying/unrealgamesync-ugs/index.md)，我们建议你运行 **不分大小写** 的 Perforce 服务器。
...
>
> ![undefined](../../../../assets/images/0b/0b755dd99f0a8f33aeae2da89b2ee0824c48fa7ff6dfcb64108e0705b3fb355e.png)
