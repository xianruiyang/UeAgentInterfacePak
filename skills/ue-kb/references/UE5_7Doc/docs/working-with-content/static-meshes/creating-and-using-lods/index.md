---
title: "创建并使用 LOD"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/creating-and-using-lods-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "管理内容", "静态网格体", "创建并使用 LOD"]
---

# 创建并使用 LOD

> 路径：虚幻引擎5.7文档 / 管理内容 / 静态网格体 / 创建并使用 LOD

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/creating-and-using-lods-in-unreal-engine
...
关于新建项目的详细教程，请参阅[创建新项目](../../../understanding-the-basics/working-with-projects-and-templates/creating-a-new-project/index.md)页面。

以上操作都完成后，给项目起个名字并指定位置，然后点击 **Create Project** 按钮。

## 创建 LOD

项目加载完成后，导航至 **Content Browser** 内的 **Meshes** 文件夹，然后找到名为 **FirstPersonCube_Rounded** 的资源。

![Cube In Content Browser](../../../../assets/images/34/34cae5cdd1154915d0e1fbfaff4ab6a6230520d27cb0b628195c7bb92861ed33.jpg)

点击查看大图。

找到该资源后，在静态网格模型编辑器中打开它，打开方式为 **double-clicking** 该资源或 **right-clicking** 该资源并从出现的关联菜单中选择 **Edit**。现在，您将可以看到类似以下画面。

![Cube In Static Mesh Editor](../../../../assets/images/8c/8c4fe8e4eeec25d36600f75c1b164253e73db7ce16442d58eb16647a96f4fa46.jpg)

点击查看大图。

在静态网格模型编辑器中打开了该资源后，找到 **Details** 面板。默认状态下，该面板位于右上角。找到该面板时，应出现以下所示画面：

![Details LOD0](../../../../assets/images/d8/d886ee8c402650013d86ac29839f655fb3827134a74d6568a799f5452f46e147.png)
...
![Import LOD Level 1](../../../../assets/images/05/0515cf3a5b9e7e95b46b6efb4402da4f7ea35c4cb1b4cc9172fe73bba72d0431.png)
...
![Successful Import](../../../../assets/images/f5/f529b65c9e4268e7deb72253940e9ab51f8e9149608f905b7144ac9c77d33e8c.png)
...
![Import LOD Level 2](../../../../assets/images/41/4142c37db4a9ed870d3782d85a18beccd9f7cea3fc72335c90e62dca7af736e0.png)
...
![Auto Compute LOD Distances](../../../../assets/images/73/735c497bf8781039af90aef878a7367d46775343c77fb36e18e71cf91a58f609.png)

点击查看大图。

为了达到演示效果，我们就取消 **Auto Compute LOD Distances** 的勾选。随后，找到 **LOD1** 下面的 **Screen Size** 值，然后将其更改为 **0.01**。这就是说，当我们在场景中设置的立方体网格模型占到屏幕尺寸的比例小于 1% 时，立方体将切换为我们之前导入为 LOD1 的网格模型（在本示例中，是一个球体）。我们也可为每个 LOD 更改材质。为了进一步演示 LOD 的功能，我们将 LOD1 的材质更改为 **M_Metal_Gold**。

![Change Material 1](../../../../assets/images/ee/ee3c18e0054d4707351bd920c448219382d3ab692006331cd54f2fbdf3412ed2.jpg)
...
查看[设置静态网格体碰撞](../setting-up-collisions-with-static-meshes/index.md)了解有关该设置的信息。
