---
title: "物理阻尼"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/physics-damping-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "物理", "物理约束", "物理阻尼"]
---

# 物理阻尼

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 物理 / 物理约束 / 物理阻尼

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/physics-damping-in-unreal-engine
...
![Physics properties in the Details panel](../../../../../assets/images/95/95853a81b76fab253271fa6d62219cb03ac6f32d2af7b983a37af8fe5e7494d8.png)
...
Setting a Physics Constraint's Motions to Limited will display the Soft LimitsLinear Limits Mod
...
欲了解约束的更多相关信息，参见： **[关于约束的用户指南](../constraints-user-guide/index.md)**

如需了解物理约束可用属性的参考，请参阅： **[物理约束参考](../physics-constraint-reference/index.md)**
