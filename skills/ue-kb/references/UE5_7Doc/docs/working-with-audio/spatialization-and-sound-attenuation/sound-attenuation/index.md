---
title: "音效衰减"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/sound-attenuation-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "处理音频", "空间化和声音衰减", "音效衰减"]
---

# 音效衰减

> 路径：虚幻引擎5.7文档 / 处理音频 / 空间化和声音衰减 / 音效衰减

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/sound-attenuation-in-unreal-engine

本文是音效衰减设置资产的参考页面。该资产会根据音效相对于聆听者的距离来控制音效的各个方面。通常情况下的聆听者便是玩家，但有时也不是。因此本文档中使用"聆听者"一词。

## 衰减（体积）

![衰减体积属性](../../../../assets/images/d4/d4efa2c5d0dce26d069b4206a55b03d486e25de03b8fee808d9fc9e18cdd8008.png)
...
![线性函数](../../../../assets/images/f1/f18bbd3f792d9bf50be9cdc354f8cc1294eb78da9e73d51aa4f7783b34f45a82.png)

这是默认函数（Linear）。使用此函数时音量将线性衰减，因此随着聆听者靠近和远离声源，音量变化将保持恒定。此函数适用于不需要严格聚焦的三维空间衰减设置的大型背景类音效之间的淡入淡出。

#### 对数

![对数函数](../../../../assets/images/35/3558fce0b0469851542c7556db5522905214907bf07f07152ddb5008d391f1fc.png)

使用此函数（Logarithmic）时，音量将按以下方式衰减：近距离时音量变化较大，远距离时音量变化较小。此函数适用于以下现场音效：需要良好的3D定位，并且在合理距离下仍可听到。

#### 反函数

![反函数](../../../../assets/images/e2/e2a389bca8ef9d4d301ba7bccb436e7859bcef7261553dfa765b6c4ebe04b839.png)

使用此函数（Inverse）时，音量变化与对数曲线的变化类似，但程度更大。此函数适用于以下音效：在远距离时刚好能听到，但当聆听者非常靠近声源时音量将明显变大。

#### 对数反函数

![对数反函数](../../../../assets/images/8a/8a0fadd82ae018aa8ddd69497eadf825990466b17a26213414cd450dc6f257f9.png)

使用此函数（Log Reverse）时，近距离时音量变化较小，远距离时音量变化较大。此函数适用于需要在较大距离范围保持高音量的音效。

#### 自然音效

![自然音效函数](../../../../assets/images/ca/ca63283c61fab05e7193c11b253f8f8e13faa587e993e07f66c37b73d8d17983.png)

此函数（Natural Sound）尝试模拟更"自然"的衰减行为，以形成与现实更接近的行为。此函数是介于对数函数与反函数之间的"中间地带"。

#### 自定义

![Custom Function Settings](../../../../assets/images/1a/1ab0b2f44155e492035661b3b1a044910b011aa3fb528ef3a7b0a93f0a1d69db.png)
...
![球体衰减形状](../../../../assets/images/0f/0f9f80523e6decc20c24b2d806b8c3ba234897854da039ebdadc8d38c083eeaf.jpg)
...
> 图片已省略：指示了胶囊体半高的胶囊体衰减

#### 胶囊体半径

此属性定义胶囊体衰减形状的内部区域半径。

> 图片已省略：指示了胶囊体半径的胶囊体衰减
...
> 图片已省略：Attenuation Submix Properties
