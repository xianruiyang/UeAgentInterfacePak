# Gameplay Framework / C++ 知识卡

## 适用范围

Actor 生命周期、Component 组合、GameMode/GameState/PlayerController/Pawn、Subsystem、C++ 与 Blueprint 边界。
...
- GameState 放所有客户端都需要知道的状态。
- PlayerController 管玩家输入、UI 所有权和本地决策。
- Actor Component 用于可组合功能，Subsystem 用于全局服务。
