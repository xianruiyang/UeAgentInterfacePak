...
breadcrumbs: ["虚幻引擎5.7文档", "建立你的开发流程", "用虚幻构建管线", "自动工具", "BuildGraph"]
---

# BuildGraph

> 路径：虚幻引擎5.7文档 / 建立你的开发流程 / 用虚幻构建管线 / 自动工具 / BuildGraph

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/buildgraph-for-unreal-engine
...
- [BuildGraph脚本条件](../../../using-the-unreal-engine-bui-33a80b15/unreal-automation-tool/buildgraph/buildgraph-script-anatomy/buildgraph-script-conditions-reference/index.md) - 学习编写BuildGraph脚本条件的语法。

- [BuildGraph 脚本类型](buildgraph-script-anatomy/buildgraph-script-types-reference/index.md) - 学习 BuildGraph 属性的有效数据类型。

- [BuildGraph脚本任务](buildgraph-script-anatomy/buildgraph-script-tasks-reference/index.md) - 了解如何利用BuildGraph创建自定义任务。

- [BuildGraph 脚本元素](buildgraph-script-anatomy/buildgraph-script-elements-reference/index.md) - 学习 BuildGraph 的元素。

## 使用 BuildGraph


- [BuildGraph功能的使用](../how-to-use-buildgraph/index.md)
