---
title: "虚幻引擎术语"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/unreal-engine-terminology"
breadcrumbs: ["虚幻引擎5.7文档", "理解基础知识", "基础知识", "虚幻引擎术语"]
---

# 虚幻引擎术语

> 路径：虚幻引擎5.7文档 / 理解基础知识 / 基础知识 / 虚幻引擎术语

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/unreal-engine-terminology
...
如需了解更多信息，请参阅[使用项目和模板](../../working-with-projects-and-templates/index.md)。
...
有关更多信息，请参阅[蓝图可视化脚本](../../../blueprints-visual-scripting/index.md)。
...
有关更多信息，请参阅[玩家控制器](../../../gameplay-systems/gameplay-framework/controllers/player-controllers/index.md)。
...
有关更多信息，请参阅[AI控制器](../../../gameplay-systems/gameplay-framework/controllers/ai-controllers/index.md)。
...
有关更多信息，请参阅[Gameplay框架快速参考](../../../gameplay-systems/gameplay-framework/gameplay-framework-quick-reference/index.md)。
...
可以在[项目设置](../../project-settings/index.md)中设置默认游戏模式，并针对不同的关卡重载游戏模式。无论你选择以何种方式实施，每个关卡都只能有一个游戏模式。
...
有关更多信息，请参阅[Game Mode 和 Game State](../../../gameplay-systems/gameplay-framework/game-mode-and-game-state/index.md)。
...
- 阻挡体积（Blocking Volumes）
  ...
  是可见的，用于阻止Actor通过它们。
- 施加伤害体积（Pain Causing Volume）

  对与其重叠的任何Actor造成持续伤害。
- 触发器体积（Trigger Volumes）

  的编程方式为，在Actor进入或退出体积时触发事件。

如需了解更多信息，请参阅[Actor参考](../../actors-and-geometry/unreal-engine-actors-reference/index.md)。
