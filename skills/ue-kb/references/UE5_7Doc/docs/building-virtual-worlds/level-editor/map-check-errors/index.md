---
title: "地图检查错误"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/map-check-errors-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "构建虚拟世界", "关卡编辑器", "地图检查错误"]
---

# 地图检查错误

> 路径：虚幻引擎5.7文档 / 构建虚拟世界 / 关卡编辑器 / 地图检查错误

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/map-check-errors-in-unreal-engine

虚幻引擎拥有智能机制，存在潜在问题时将以地图检查错误和警告的形式提醒用户，在了解问题诱因和修复方法之前便不需要手动追踪问题。这些错误可自动追踪问题所在，便于开发者进行修复，避免问题对游戏造成严重影响。

## 执行地图检查

执行地图全部编译后将显示地图检查错误和警告，也可使用 [关卡编辑器工具栏](../level-editor-toolbar/index.md) 中 Build 菜单内的 *Map Check* 选项单独执行。
