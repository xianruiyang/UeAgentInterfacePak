...
- 围绕“8.如何在虚幻引擎 5 中保持 PCG 树木直立？”整理 PCG 视频中的输入数据、图表规则、关键节点、参数风险和最终生成结果。
...
- `Transform Points`、`Static Mesh Spawner`、`Absolute Rotation`、`Landscape Normal`、`Slope Alignment`、`Yaw`、`PCG`、`点`、`生成`、`网格`

## 分段知识

### 00:00:00-00:00:41 点数据、Bounds 与采样来源
