...
- 围绕“【UE5.3.1 PCG教程】使用子图表SubGraph工程创建程序化建筑”整理 PCG 视频中的输入数据、图表规则、关键节点、参数风险和最终生成结果。
...
- `PCG`、`Blueprint`、`Static Mesh`、`Mesh`、`VolumeSampler`、`SubGraph`、`Transform`、`Point`、`Attribute`、`Actor`、`Component`、`Spawn`、`Grid`、`Bounds`、`Density`、`Seed`、`Graph`、`Material`

## 分段知识

### 00:00:00-00:03:00 属性、过滤与数据分流
