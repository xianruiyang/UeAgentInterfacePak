---
title: "开放世界场景工具提示和技巧"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/open-world-tools-tips-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "构建虚拟世界", "开放世界工具", "开放世界场景工具提示和技巧"]
---

# 开放世界场景工具提示和技巧

> 路径：虚幻引擎5.7文档 / 构建虚拟世界 / 开放世界工具 / 开放世界场景工具提示和技巧

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/open-world-tools-tips-in-unreal-engine

![Tip-Trick Header](../../../../assets/images/ca/ca5526ed0d87945d9188d5c0321f071bf6dd752c1fe364eaddc93cf1a636b55c.jpg)
...
> [!NOTE]
> 如需了解开放世界场景工具使用的更多基础信息，请查阅 [程序化植物快速入门](../procedural-foliage-tool/index.md) 或 [草地工具快速入门](../grass-quick-start/index.md)。
...
![Grass Tool Cull Distance](../../../../assets/images/7e/7e38a8dfc48d627d2bc7ccadad4ea68ab361e0595f1a7dc74117817f67516179.png)

点击查看大图。

上图为风筝 demo 中部分草地静态网格体的剔除设置。 上图中的原始数值为 6,500，如将其改为 30,000，较远的草地静态网格体也将被渲染。

![Default of 6,500](../../../../assets/images/11/11a1bc5e65d6a4462e3b37ef8684eca05f4c460081f1c6f73d44836f7e4b7ed9.jpg)

![Set to 30,000](../../../../assets/images/c7/c79714b55ed3228a26376ced10d2cb6f48e4aaeb22a91373f4129fa9df54a55b.jpg)
...
![Console](../../../../assets/images/6b/6bfde5dcd985de0f0f896c1fe273885a88f73fa9f57ebe44b45769b2f5299143.png)

点击查看大图。

将命令 **Foliage.MinimumScreenSize 0.0001** 输入控制台，然后按下 **Enter** 键应用。 重建草地图后，在视口中可以发现更远距离的静态网格体将被渲染。

![Foliage Command](../../../../assets/images/30/306a9057953474d932b430df22cc744fa9a985de3503b7d6fd0dc3fe5d5a34a4.png)

点击查看大图。

对比图显示默认设置 **0.0001** 和 **0.00000001** 之间的剔除距离差异。

![Original Settings of 0.0001](../../../../assets/images/e0/e024100e1841f52007bc20bea19076f5430bbb9ed191bd120f54c43ea6d4d9ea.jpg)

![Max Settings of 0.00000001](../../../../assets/images/41/413c24b564691f659550aa1510050b6d0c8ae97d4f160a1798c7893f1d1016a3.jpg)
