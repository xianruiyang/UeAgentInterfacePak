---
title: "可行走斜面"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/walkable-slope-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "物理", "可行走斜面"]
---

# 可行走斜面

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 物理 / 可行走斜面

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/walkable-slope-in-unreal-engine
...
![Override Walkable Slope](../../../../assets/images/86/864bde07cb69b728280215a5aaecf49e2404ae002e6a1a4e345a30d0db1524cd.png)
...
- 如
  ...
  的数值为 90.0，角色可以走过物理形体上小于 90 度的任何角度（不包括 90 度）。
...
- 如
  ...
  表面。此设置可能会在接近于平面的表面上形成一些奇怪的行为，角色将滑过这些表面但无法改变方向。
- Walkable Slope Angle
