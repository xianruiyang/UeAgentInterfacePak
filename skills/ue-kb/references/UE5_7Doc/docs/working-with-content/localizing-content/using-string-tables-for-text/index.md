---
title: "字符串表"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/using-string-tables-for-text-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "管理内容", "本地化", "字符串表"]
---

# 字符串表

> 路径：虚幻引擎5.7文档 / 管理内容 / 本地化 / 字符串表

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/using-string-tables-for-text-in-unreal-engine
...
| `LOCTABLE_FROMFILE_X` | 创建一个字符串表实例，并从给定的CSV文件填充。当使用_ENGINE变量时，文件相对于引擎内容目录，当使用_GAME变量时，文件相对于项目内容目录。 |
...
```
    // 从CSV文件创建并填充字符串表    LOCTABLE_FROMFILE_GAME("CSVStringTable","CSVStringTable","StringTableCSV/TestStrings.csv");
```
