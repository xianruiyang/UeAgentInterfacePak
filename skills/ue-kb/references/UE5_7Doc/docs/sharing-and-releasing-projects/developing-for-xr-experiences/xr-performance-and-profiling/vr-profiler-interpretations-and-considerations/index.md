---
title: "VR分析解译与注意事项"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/vr-profiler-interpretations-and-considerations-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "分享和发布项目", "XR开发", "XR性能和分析", "VR分析解译与注意事项"]
---

# VR分析解译与注意事项

> 路径：虚幻引擎5.7文档 / 分享和发布项目 / XR开发 / XR性能和分析 / VR分析解译与注意事项

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/vr-profiler-interpretations-and-considerations-in-unreal-engine

[分析工具](../vr-profiling-tools/index.md) 可提供项目如何在 VR 中执行的数据，而解译这些数据时有一些注意事项。
