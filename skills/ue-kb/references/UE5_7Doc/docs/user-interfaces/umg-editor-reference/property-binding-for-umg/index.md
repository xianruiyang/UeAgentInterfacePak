---
title: "属性绑定"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/property-binding-for-umg-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "创建用户界面", "UMG编辑器参考", "属性绑定"]
---

# 属性绑定

> 路径：虚幻引擎5.7文档 / 创建用户界面 / UMG编辑器参考 / 属性绑定

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/property-binding-for-umg-in-unreal-engine
