---
title: "Chaos Flesh概述"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/chaos-flesh-overview"
breadcrumbs: ["虚幻引擎5.7文档", "Gameplay系统", "物理", "Chaos Flesh", "Chaos Flesh概述"]
---

# Chaos Flesh概述

> 路径：虚幻引擎5.7文档 / Gameplay系统 / 物理 / Chaos Flesh / Chaos Flesh概述

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/chaos-flesh-overview
...
- 第二种方法使用
  ...
  实际应用场景下的四面体网格划分（TetWild）（Tetrahedral Meshing in the Wild (TetWild)）
