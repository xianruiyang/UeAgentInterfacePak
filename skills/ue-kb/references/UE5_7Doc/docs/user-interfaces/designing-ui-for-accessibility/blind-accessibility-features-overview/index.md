---
title: "视觉障碍辅助功能介绍"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/blind-accessibility-features-overview-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "创建用户界面", "无障碍功能", "视觉障碍辅助功能介绍"]
---

# 视觉障碍辅助功能介绍

> 路径：虚幻引擎5.7文档 / 创建用户界面 / 无障碍功能 / 视觉障碍辅助功能介绍

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/blind-accessibility-features-overview-in-unreal-engine
...
如果你使用[Slate](../../slate-user-interface-programming-framework/slate-overview/index.md)来实现你的UI，请考虑使用Slate屏幕阅读器。
...
你可以从主菜单中启用全部三个插件（**编辑（Edit） > 插件（Plugins）**）。如果你需要了解如何启用插件，请参考[使用插件](../../../understanding-the-basics/foundational-knowledge-in/working-with-plugins/index.md)页面。
