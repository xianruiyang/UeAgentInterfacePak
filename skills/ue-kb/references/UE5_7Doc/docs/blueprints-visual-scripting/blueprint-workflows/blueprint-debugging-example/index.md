---
title: "蓝图调试示例"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/blueprint-debugging-example-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "蓝图可视化脚本", "蓝图工作流程", "蓝图调试示例"]
---

# 蓝图调试示例

> 路径：虚幻引擎5.7文档 / 蓝图可视化脚本 / 蓝图工作流程 / 蓝图调试示例

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/blueprint-debugging-example-in-unreal-engine
...
蓝图调试器（Blueprint Debugger）可在PIE和SIE会话期间控制游戏的执行。游戏运行时，[工具栏](../../user-interface-reference-for-the-blueprint-73593f79/user-interface-components/toolbar-in-the-blueprints-visual-scripting-editor/index.md)中的功能按钮将启用。根据当前调试的蓝图类型和调试会话的当前状态，所出现的调试功能按钮会有所不同。某些功能按钮仅在需要时才启用，例如运行到 **断点** 时。
...
![ActiveBreakpoint.png](../../../../assets/images/a8/a8625d8b3adaec3a79b9d9b688658c96f9d337ef840b039250a32108af1375f7.jpg)
...
![InactiveBreakpoint.png](../../../../assets/images/ee/ee67040dc547981f250669f52ac95d363b9326285ea8224263d0d587f9769446.jpg)
...
![WarningBreakpoint.png](../../../../assets/images/b0/b0f9c2fea53bff1eb620e0313adf5e89e5ec25422614a357a63865e8ab506aa6.jpg)

这个断点是无效的，永远不会被命中。在某些情况下，重新编译蓝图可以解决此问题。

使用断点暂停执行时，编辑器将突出显示并聚焦该节点，并在其上放置一个大的红色箭头。

![BreakingOnBreakpoint.png](../../../../assets/images/b6/b61dd4588be6628ea603449a69ffd09f50c28b31930a36dce5da676212634c76.jpg)
...
![CallStack.png](../../../../assets/images/a6/a602463d1199b17603a2bdc67404b2d761660303f155c92c51d55fb251152871.jpg)
...
![BpCallStack.png](../../../../assets/images/84/84d7dd512b496d21b493657f53282cb58f9aec0f92aee7c8ba7064f5727d0ae2.jpg)
...
![蓝图调试 - 执行追踪堆栈](../../../../assets/images/65/6539eddcfcaa8e8db6b7d54a521f8a1167e51c6443c9279b7bbdcb225d359b49.jpg)
