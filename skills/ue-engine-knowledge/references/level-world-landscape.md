# Level / World / Landscape 知识卡

## 适用范围

关卡结构、World Partition、Streaming、Landscape、导航、碰撞、地形性能和大型场景组织。
...
- 先保证可玩路径、尺度和导航，再做装饰。
- 大世界优先规划 streaming、HLOD、World Partition 和 Data Layer。
- Landscape 适合大地形，不适合所有细节结构。
- 导航、碰撞和可达性是验收项。
