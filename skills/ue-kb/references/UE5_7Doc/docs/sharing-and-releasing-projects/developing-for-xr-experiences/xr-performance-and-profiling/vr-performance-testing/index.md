---
title: "VR 性能测试"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/vr-performance-testing-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "分享和发布项目", "XR开发", "XR性能和分析", "VR 性能测试"]
---

# VR 性能测试

> 路径：虚幻引擎5.7文档 / 分享和发布项目 / XR开发 / XR性能和分析 / VR 性能测试

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/vr-performance-testing-in-unreal-engine
...
如使用 [最佳方法指南](../../getting-started-with-xr-development/xr-best-practices/index.md) 中的控制台变量设置，渲染线程性能应该达到理想效果。因此，对内容和游戏代码进行优化十分重要，可借此榨取帧率。需要尽量简化所有内容。
