---
title: "使用 Sprite 插槽"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/paper-2d-sprite-sockets-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "为角色和对象制作动画", "虚幻引擎", "Paper 2D指南", "使用 Sprite 插槽"]
---

# 使用 Sprite 插槽

> 路径：虚幻引擎5.7文档 / 为角色和对象制作动画 / 虚幻引擎 / Paper 2D指南 / 使用 Sprite 插槽

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/paper-2d-sprite-sockets-in-unreal-engine
