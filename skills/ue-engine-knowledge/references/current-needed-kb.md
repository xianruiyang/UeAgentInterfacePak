...
- P0：Blueprint、Gameplay/C++、GAS、SaveGame、Enhanced Input、Level、Sequencer、Niagara。
- P1：Niagara 模块索引、Static Mesh、Performance、Pipeline、Lyra、UMG、CommonUI、Material。
- P2：Animation/IK、AI、PCG、Networking、Audio。
- 覆盖定义包含官方入口、架构判断、实现清单、调试流程和风险说明。
