---
title: "使用子动画实例"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/using-sub-anim-instances-in-unreal-engine"
breadcrumbs: ["虚幻引擎5.7文档", "为角色和对象制作动画", "骨架网格体动画系统", "动画操作指南和示例", "使用子动画实例"]
---

# 使用子动画实例

> 路径：虚幻引擎5.7文档 / 为角色和对象制作动画 / 骨架网格体动画系统 / 动画操作指南和示例 / 使用子动画实例

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/using-sub-anim-instances-in-unreal-engine
...
4. 从 **细节（Details）** 面板为 **FABRIK** 节点分配以下设置。
   ...
   - 取消选中
     ...
     （作为引脚）效果器转换（(As Pin) Effector Transform）
   - 将
...
8. 在 **内容浏览器** 中的 **Content/Mannequin/Animations** 下面，打开 **ThirdPerson_AnimBP**。
