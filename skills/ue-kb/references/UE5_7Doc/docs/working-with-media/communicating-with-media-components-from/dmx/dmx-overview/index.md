---
title: "DMX概述"
source_url: "https://dev.epicgames.com/documentation/unreal-engine/dmx-overview"
breadcrumbs: ["虚幻引擎5.7文档", "使用媒体", "与媒体组件通信", "DMX", "DMX概述"]
---

# DMX概述

> 路径：虚幻引擎5.7文档 / 使用媒体 / 与媒体组件通信 / DMX / DMX概述

> 原始页面：https://dev.epicgames.com/documentation/unreal-engine/dmx-overview
...
![DMX数据结构](../../../../../assets/images/99/99331172d8cecf1ea9351b4b75ad95f9c92628b1f491e532544e91b85826bde2.jpg)
...
![联网到计算机的灯具充当DMX控制台](../../../../../assets/images/91/9185b891c96757072dfd88833db77bebe83facfe0e5156f0e57b6fd0f111681e.jpg)
...
![DMX灯具](../../../../../assets/images/dc/dc0decb20efdd5c6fe132bc32da01b02a66140fa369fdfd29519843f855c44d9.jpg)

请参阅[DMX灯具](https://dev.epicgames.com/documentation/404)文档，了解更多信息。
...
![DMX网络的逻辑组织](../../../../../assets/images/b9/b98cccb1567a448730ba9d2880a1ac1d410309597cca308ac3905221bc7b603d.png)

| **名称** | **说明** |
| --- | --- |
| 域 | 每个域可以包含许多以菊链形式连接在一起的灯具，每个域最多512字节。 |
| 灯具 | 每个灯具在域中占用一个或多个地址。 |
| 起始地址 | 灯具的起始地址确定灯具应该如何解译接收到的DMX数据包（字节数组中的单个索引）。 |
| 属性 | 一个灯具包含一组由其当前模式定义的属性，每个属性都具有一个由其属性编号（信道）加上起始地址确定的地址（见下图"灯具配接"下的示例）。 |
...
![示例域中的地址范围。](../../../../../assets/images/c0/c0bc8cc1c2627e1f81ff112a7ee6448915725e173c4956eb6401e07387266fbc.jpg)
